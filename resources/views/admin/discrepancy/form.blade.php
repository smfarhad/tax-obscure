                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input name="asses_year" value="{{ old('asses_year') }}" class="form-control" placeholder="Asses Year" type="text" required>
                                </div>
                            </div>                            
                            <div class="form-group">
                                <label for="comments" class="col-sm-2 control-label">Short Notes</label>
                                <div class="col-sm-10">
                                    <textarea name="comments" id="comments" class="textarea" placeholder="Place short desc" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('comments')}}</textarea>
                                </div>
                            </div>                                
                        </div>
                        <!-- /.box-body -->
