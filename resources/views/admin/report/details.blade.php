                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-6">
                                            {{$show->asses_year}} - {{$show->asses_year+1}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input name="hearingDate" value="{{ old('hearing_date') }} " class="form-control hearingDate" data-date-format="yyyy-mm-dd" placeholder="hearingDate" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="hearingDate" class="col-sm-4 control-label">Hearing Place</label>
                                                                    <div class="col-sm-6">
                                                                        <input name="place" value="{{ old('place') }} " class="form-control" placeholder="Place" type="text" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- /.box-body -->
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px"> @if($row->hearing_date != '0000-00-00') {{$row->hearing_date}} @endif </td>
                                                <td style="width: 200px">{{$row->place}}</td>
                                                <td style="width: 100px">
                                                    ...
                                                    @elseif ($row->hearing_date == '0000-00-00')
                                                    <button type="button" class="btn btn-block btn-warning btn-xs">Date Not Set</button>
                                                    @else
                                                ...
                                                <td style="width: 100px">
                                                    ...
                                                    <div class="modal fade" id="editHearing{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                {{ Form::open(array('url' => 'admin/price', 'class'=>'form-horizontal')) }}
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    <h4 class="modal-title" id="myModalLabel">Hearing Date</h4>
                                                                </div>
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="box-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="hearingDate" class="col-sm-4 control-label">Place</label>
                                                                            <div class="col-sm-6">
                                                                                <input name="place" value="{{$row->place}}" class="form-control" placeholder="Place" type="text" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- /.box-body -->
